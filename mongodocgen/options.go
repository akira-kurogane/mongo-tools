...
// Name returns a description of the GenerationOptions struct. Only used by the 
// mongo tools options class when it produces --help output.
func (_ *GenerationOptions) Name() string {
	return "generation"
}

// IngestOptions defines the set of options for how the data is inserted
// to the target db.
...
// Name returns a description of the IngestOptions struct. Only used by the 
// mongo tools options class when it produces --help output.
